...
void setup() {
    Serial.begin(115200);
    /**
     * Start the DMX driver in dual forward mode on Serial2 (pins 16 and 17).
    ...
    */
    dmx.begin(DMXMode::BothKeepRx, DMXPin::Serial2Rx, DMXPin::Serial2Tx);
}

void loop() {
    // We can listen to the DMX Channels and they will automatically be transmitted again.
